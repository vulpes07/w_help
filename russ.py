...
2. **Общественный фонд «Кыргызстан Жаштар Ынтымагы»**  
...
4. **Общественный благотворительный фонд «Сантерра-Юг»**  
...
5. **Социальные магазины при муниципальных территориальных управлениях**  
...
6. **Ошское городское управление социального фонда**  
...
async def cmd_house_rus(message: types.Message):
    ...
    await message.answer(
        f"""
1. **Шелтер при Общественной организации «Мусаада»**  
...
3. **Общественные организации и инициативы**  
...
2. **Кризисный центр «Аруулан» при ОО «Аялзат»**  
...
3. **Общественное объединение «Мээрбан»**  
